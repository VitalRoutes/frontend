...
const CLASSES = {
  primary:
    'w-full rounded-xl font-bold bg-gray-1 py-4 text-gray-11 hover:bg-green-1 hover:text-black disabled:bg-gray-2 disabled:text-gray-4',
  'secondary-a':
  ...
  'third-a':
    'rounded-full shrink-0 font-bold bg-gray-6 px-4 py-2 xl:text-base text-sm xl:px-9 xl:py-5 text-gray-1 hover:bg-green-1 disabled:bg-gray-6 disabled:text-gray-3',
  'third-b':
    'rounded-full shrink-0 bg-gray-6 px-4 py-2 xl:text-base text-sm xl:px-9 xl:py-5 text-gray-1 hover:bg-gray-1 hover:text-green-1 disabled:bg-gray-6 disabled:text-gray-3',
  'third-c':

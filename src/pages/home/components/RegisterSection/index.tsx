...
const CARDS_INFO = [
  {
    imgSrc: `${BASE_IMG_SRC}/registration/registration_1.png`,
    title: '산책하기',
    desc: '원하는 산책경로로 이동해보세요',
  },
  {
    imgSrc: `${BASE_IMG_SRC}/registration/registration_2.png`,
    title: '인증사진 찰칵!',
    desc: '인증이 필요한 지점에서 사진을 찍어주세요.',
  },
  {
    imgSrc: `${BASE_IMG_SRC}/registration/registration_3.png`,
    title: '챌린지 글 남기기',

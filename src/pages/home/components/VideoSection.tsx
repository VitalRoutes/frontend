...
function VideoSection({ className = '' }: Props) {
  const TITLE_CLASS = {
    h1: 'text-[32px] sm:text-[70px] font-bold leading-[120%] text-gray-11 uppercase',
    h2: 'text-[14px] sm:text-[40px] leading-[64px] font-bold text-gray-11 uppercase',
  };
  return (
    <div className={twMerge('h-[520px] w-full xl:h-[1080px]', className)}>
      <div className="h-full w-full bg-gray-2" />
      <div className="absolute left-[21px] top-[175px] sm:left-[200px] sm:top-[420px]">
